  ...
  ({
    ...
    return (
      <div
        ...
        className="h-full flex flex-col items-center overflow-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent"
      >
        <div className="w-full h-full p-4 max-w-[1058px]">
          <div className="relative pb-44">
            <div className="flex flex-col rounded-md">
              <div className="flex-1 overflow-y-auto rounded-xl text-sm leading-6 sm:leading-7 text-gray-800">
            ...
            <div className="fixed flex justify-center left-0 bottom-0 w-full bg-gradient-to-b from-transparent via-white/50 to-white backdrop-blur-sm">
